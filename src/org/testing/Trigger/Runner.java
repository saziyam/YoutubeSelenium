...
public class Runner {
	...
	public static void main(String[] args) throws BiffException, IOException {
		try {
			XmlSuite xS = new XmlSuite(); // suite object xS.setName("Suite1"); // nameset

			XmlTest xT = new XmlTest(xS); // test object
			
			File f=new File("/Users/saziya/eclipse-workspace/YTFramwork/src/org/testing/InputData/Runner.xls");
